...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'E:\\SCAN\\Summer Semester\\Experiment\\OneStepFurther.psyexp',
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trial_redComponents = [polygon_2, Noise_patch, ISI, polygon, key_resp_3, Fixation_cross1, Fixation_cross2]
