...
expName = 'OneStepFurther'  # from the Builder filename that created this script
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trial_redComponents = [ISI, polygon, key_resp_3, polygon_2]
    ...
    while continueRoutine:
        ...
        # *polygon* updates
        if t >= 3 and polygon.status == NOT_STARTED:
            # keep track of start time/frame for later
            polygon.tStart = t
        ...
        # *key_resp_3* updates
        if t >= 3.5 and key_resp_3.status == NOT_STARTED:
            # keep track of start time/frame for later
            key_resp_3.tStart = t
        ...
        # *polygon_2* updates
        if t >= 1 and polygon_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            polygon_2.tStart = t
...
for thisTrial_2 in trials_2:
    ...
    red = 0.5
    # keep track of which components have finished
    trial_blueComponents = [polygon_3, polygon_4, key_resp_4]
...
for thisTrial_3 in trials_3:
    ...
    blue = 0.5
    # keep track of which components have finished
    trial_greenComponents = [polygon_5, polygon_6, key_resp_5]
